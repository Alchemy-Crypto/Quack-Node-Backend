...
eth.accounts.wallet.add(process.env.META_PRIVATE_KEY)
...
module.exports = class AdminService {
    ...
    static async initialDistribution() {
        ...
        members.forEach( async (member) => {
            const memberVerification = await contract.methods.distributeQuacks(member, quackPerMember).sendTransaction().on('receipt', receipt => receipt);
